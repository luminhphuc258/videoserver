...
def index():
    ...
    # dùng f-string để inject NODE_* vào HTML
    # LƯU Ý: mọi JS object literal phải dùng {{ }} để không bị Python xử lý
    html = f"""
<!DOCTYPE html>
<html>
<head>
...
<script>
/* ==========================================================
   CAMERA ROTATE — gọi NodeJS /camera_rotate
========================================================== */
...
/* ==========================================================
   ACTIVE LISTENING (unchanged, chỉ ESCAPE {audio:true})
========================================================== */
...
async function startRecordingManual(){{
    // ⭐ ESCAPED: {{audio:true}} để Python không hiểu nhầm
