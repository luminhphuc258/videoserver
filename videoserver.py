...
# NODEJS ENDPOINTS
# ============================
NODEJS = "https://embeddedprogramming-healtheworldserver.up.railway.app"

NODE_UPLOAD = f"{NODEJS}/upload_audio"
NODE_CAMERA = f"{NODEJS}/camera_rotate"

SCAN30  = f"{NODEJS}/trigger_scan30"
SCAN45  = f"{NODEJS}/trigger_scan45"
SCAN90  = f"{NODEJS}/trigger_scan90"
SCAN180 = f"{NODEJS}/trigger_scan180"
SCAN360 = f"{NODEJS}/trigger_scan"


# ==========================================
# HOME PAGE (FULL HTML + FIX CAMERA BUTTON)
# ==========================================
@app.route("/")
def index():
...
<button id="showDataBtn" style="background:#ff0;color:#000;margin-top:10px;">Show Map</button>
...
<script>
/* ==========================================================
   CAMERA ROTATE — FIXED FORMAT FOR NODEJS
========================================================== */
